...
```{r pct_change_filtered, out.width="80%", fig.cap="Percentage change in direct CN/HK flights between the December 2019 baseline and March 2020 for countries with ≥5 December flights (n = 21). Every country cut traffic by at least 50%; 7/21 reduced >90%, and 14/21 ≥75%. Belgium, the Netherlands and Germany retained the highest residual volumes.", fig.align='center'}
