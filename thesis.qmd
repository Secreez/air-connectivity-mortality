...
Our own test (Coverage-audit)[#coverage-audit] shows that OpenSky records **no** CN/HK arrivals for five EUROCONTROL states and under-counts most others.
...
[ !!!!!!! REWRITE ! TABLE SHORTEN !!!!! THEN ADD EXPANDED TO APPENDIX A !!!!!!! ]
...
OpenSky misses **GEO, HRV, PRT, SVK and UKR entirely** and under-counts 14 of the remaining 21 states (median deficit ≈ 12 flights; full breakdown in Appendix A).
