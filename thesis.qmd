...
| **Preighters**         | Passenger aircraft temporarily converted to carry cargo                                                        
                                     |
| **HAQ**                | Healthcare Access and Quality Index (Global Burden of Disease amenable-mortality–based score, 0–100; higher = better access/quality).              |
| **UHC**                | Universal Health Coverage service-coverage index (WHO/World Bank composite of essential health services, 0–100; higher = broader coverage).          |
