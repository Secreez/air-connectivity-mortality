...
* **Why the ± 7-day rule?** WMD releases deaths in weekly blocks for ≈ 80 % of countries (fortnightly for most others). Following @karlinsky2021 guidance to respect that cadence, we select the closest block to 5 May—adding at most a ± ½-week timing blur, trivial alongside the WMD’s own **3 – 12 %** standard errors for high-income Europe.
...
* **Excess-mortality uncertainty.** WMD delivers deaths in weekly blocks (≈ 80 % of our sample) and fortnightly blocks for the rest. Choosing the observation nearest to 5 May within a ± 7-day window therefore adds at most a ± ½-week timing blur—trivial beside the WMD’s own 3 – 12 % standard errors for high-income Europe [@karlinsky2021]. Even so, registration lags, baseline-fit choices and death-certification rules still differ across countries, leaving some residual cross-country noise [@msemburi2023; @kelly2021].
