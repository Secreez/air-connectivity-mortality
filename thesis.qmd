...
| ------------------------- | --------------- | ------ | --------------------------------------- |
| Chinazzi et al. 2020      | ...             | ...    | ...                                     |
| Sun et al. 2022_a           | Narrative review (≈200 papers)            | Global & intra-EU    | Synthesises evidence that aviation shrinks “effective distance” and that first-wave importations preceded capacity collapses                                     |
| Strohmeier et al. 2021    | ...             | ...    | ...                                     |
| Warnock-Smith et al. 2021 | OAG seats + Sabre MIDT fares (2017-20) | CN domestic / CN-EU / CN-Asia | Domestic LCCs rebound, secondary CN–EU routes collapse, trunk HKG–LHR persists as high-fare ghost flight |
| ...                       | ...             | ...    | ...                                     |
| ...                       | ...             | ...    | ...                                     |
...
Filters: ICAO flight types *S* / *N*; **$ADEP ∈ {CN, HK}$ (all mainland-Chinese and Hong Kong airports); $ADES ∈$ the 26 continental member states.**  
*We therefore count flights from **every** CN/HK origin, mirroring the hub-substitution effect documented by @chinazzi2020*
...
* **Vaccination rollout.** OWID data show that by **5 May 2022** countries in the highest-exposure quartile had a median **≈ 78 %** of their populations fully vaccinated, vs **≈ 62 %** in the lowest-exposure quartile—a **16-point lead** that likely suppressed late-wave mortality and contributed to the sign-flip after 2021.

* **Policy timing & capacity.**  Countries that paired **high government effectiveness** with **early, stringent domestic NPIs** clustered in the lowest excess-mortality group during 2020-21 [@rahmanian2024].  Consistent with the global review by **@sun2022_a**, which finds that stand-alone travel bans are blunt unless layered with vaccination and local measures [@sun2022_a], our results suggest that flight exposure mattered only for the first wave; thereafter domestic defences dominated.
