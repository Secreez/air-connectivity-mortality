...
Among the **19 countries that logged ≥ 5 direct CN/HK flights in December 2019**, every one had slashed traffic by **at least 50 %** by the end of March 2020.

* **15 / 19 cut more than 90 %** hence the long run of bars pinned near 100 %.
* **Belgium, the Netherlands and Germany** are the only three retaining anything like half their December volume, yet even they are down 30-50%.
* All three are cargo‑ or transfer‑heavy hubs, so many of those “surviving” rotations were freighters or near‑empty slot holders (see [Data limitations](#data-limitations)).

| signal            | take‑away                                                                                                                                                                            |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Timing**        | The plunge aligns with the **EU/Schengen external‑border stop (17 Mar)** and China’s **“Five‑One” rule (26 Mar)** that limited each airline to one weekly CN–EU rotation.            |
...
> With direct CN/HK traffic cut to a trickle after late March, whatever differences we still observe in first‑wave mortality have to come from the flights that landed before the cliff‑edge. The rest of the results section therefore tests whether that pre‑collapse exposure is visible in countries’ excess‑mortality snapshots for 5 May 2020.

*(External yard‑stick: by December 2020, CN-EU long‑haul capacity was ≈ 7 % of 2019 levels, while China’s domestic network had rebounded to ≈ 93 % [@warnocksmith2021].)*

### Baseline2020 snapshot – 5 May 2020 {#baseline‑2020}
