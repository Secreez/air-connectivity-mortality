...
**Scope note.** We did not model vaccination, NPIs, GDP, or other covariates; any references to these in the Discussion are descriptive context rather than part of the statistical tests.
...
Across the 26 continental EUROCONTROL states, heavier direct CN/HK traffic was linked to **substantially higher first-wave excess mortality** (ρ = 0.53, *p* = 0.007).  
Within one year the association faded, and by 2022-23 it had flipped negative (ρ ≈ –0.45).

## Why did the signal fade?

* **Wealth & vulnerability.** A 34-country panel finds that excess-death percentage falls as GDP-per-capita rises (Pearson r ≈ –0.60; Spearman ρ ≈ –0.69) and climbs with poverty and inequality [@ioannidis2023]. The hubs with the heaviest CN/HK traffic (DEU, GBR, NLD, FRA) also sit in Europe’s upper GDP tercile, which helps explain why the positive flight–mortality link vanishes after 2020.
