...
Figure @fig-rho-caterpillar shows that only the 2020 coefficient is significantly positive; from 2021 onward the confidence intervals straddle (or fall below) zero, confirming the sign‑flip.
