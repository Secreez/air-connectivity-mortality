...
p_scatter <- ggplot(
  ...
  labs(
    ...
    y = "Distinct CN/HK/MO origin airports",
    caption = glue::glue(
      "Spearman ρ = {rho_air} (p {p_air}); 38 airports; ",
      "ties handled via exact = FALSE"
    )
  ) +
