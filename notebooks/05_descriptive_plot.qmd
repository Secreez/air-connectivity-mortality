...
p_top10 <- ggplot(
  ...
  labs(
    ...
    subtitle = "Direct passenger flights from China & Hong Kong*  (Dec 2019 / Mar 2020)",
    x = NULL, y = "Number of flights",
    caption  = "*No Macao–Europe flights were recorded in the EUROCONTROL dataset."
  ) +
...
p_scatter <- ggplot(
  ...
  labs(
    ...
    y = "Unique CN/HK origin airports",
...
```{r pct_change_filtered, fig.cap="March collapse in direct CN/HK → Eurocontrol flights % change in scheduled flights, Mar 2020 vs. Dec 2019 countries - with ≥ 5 December flights", fig.height=6}
...
knitr::kable(
  collapse_tbl,
  caption = "Direct CN/HK passenger flights: Dec 2019 vs Mar 2020 \
...
knitr::kable(
  top_tbl,
  caption = "Largest proportional drops / increases in direct CN/HK flights \
...
* **Largest drops**: Hub–and-spoke carriers in Italy, Türkiye, Finland and Denmark virtually shut direct China/HK traffic (–86 % to –96 %).
...
```{r origin_stack, fig.cap="Flight counts per CN/HK origin"}
