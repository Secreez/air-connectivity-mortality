...
The EUROCONTROL air traffic data were filtered to include:

- Origin airports located in **Mainland China, Hong Kong, and Macao**.
- Destination airports located in **EUROCONTROL member states**.

To ensure accurate country-level aggregation, **airport codes were matched using the openly available OurAirports dataset** [@ourairports2025], which provides global airport information in the public domain. Following the matching process, the flight records were aggregated at the **destination country** level, separately for:
- **December 2019** (reflecting international air traffic patterns prior to formal global recognition and containment measures of the COVID-19 pandemic [@chinazzi2020])
- **March 2020** (reflecting the onset of European lockdowns and flight restrictions)

This aggregation resulted in a **country-level flight exposure ranking** based on the total number of inbound flights from China, Hong Kong, and Macao.

#### Mortality Data

The cumulative excess mortality dataset was cleaned and harmonized by ISO3 country code to ensure consistency with the flight data. Mortality values were extracted for four annual reference dates to capture long-term pandemic impacts:
...
These data are based on ... *add more details*

(*Note: The choice of 05 May as an annual reference date ... Further detail is provided in Section X.X.*)
