...
[NEEDS BETTER REFERENCE .. perhaps add OurAirports even into the references]
...
[WHY 05 May? - NEEDS BETTER REFERENCE ..]
...
assess the robustness of the correlation results, additional analyses:

- **Exclusion of small-population countries** (e.g., countries with <2 million population)
- **Exclusion of countries with incomplete mortality data**
- **Optional normalization** of exposure by population size (exposure per 1 million inhabitants)
- **Comparison of correlations across December, March, and combined data** to evaluate potential timing effects

*Table 4.6: Sensitivity analysis results.*

### Summary of Key Patterns

briefly summarizes the key findings of the results:
