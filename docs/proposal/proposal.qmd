...
An upcoming short communication by Neuwirth & Elixhauser (202x, in prep.) explores how socioeconomic factors such as GDP, median age, healthcare capacity, and vaccination coverage interact as part of a causal system influencing COVID-19 mortality. While their focus is global and system-based, their findings reinforce the importance of European data, given its high reliability and completeness—justifying the Europe-focused approach taken in this thesis.
