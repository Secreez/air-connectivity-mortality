...
# 3. Extract ICAO codes for China, HK, MO
china_airports <- airports %>%
  filter(iso_country %in% c("CN", "HK", "MO"), !is.na(icao_code)) %>%
  pull(icao_code)

# 4. Extract ICAO codes for the Eurocontrol zone
...
# 7. Summarize flights from China -> Europe
...
cat("Total flights (raw):", total_flights, "\n")
cat("Total flights (cleaned):", cleaned_flights, "\n")
cat("Percentage removed:", removed_pct, "%\n")
cat("China to Eurocontrol flights (Feb 2020):", china_to_europe_flights, "\n")
